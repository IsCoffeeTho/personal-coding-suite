...
export default [
	vscode.commands.registerTextEditorCommand('personalCodingSuite.personalHeader.generate', (editor: vscode.TextEditor) => {
		var text = generateHeader(editor);
		editor.edit((edit) => { edit.insert(new vscode.Position(0, 0), `${text}\n`); });
	}),
